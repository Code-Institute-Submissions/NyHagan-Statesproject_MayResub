# Allows flask and other elements to function
import os
from flask import (
...
# function to grab the documents from mongo and display on names.html
@app.route("/")
@app.route("/get_names")
def get_names():
...
# authentication to allow logging in
...
# delete a fact via this function
